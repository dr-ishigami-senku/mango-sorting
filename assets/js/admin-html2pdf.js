...
downloadBtn.addEventListener('click', function () {
    ...
    dashboardText.textContent = document.getElementById("merchantButton").textContent + "'s Table";
    dateText.textContent = document.getElementById("dateButton").textContent;
